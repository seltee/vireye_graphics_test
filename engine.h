...
class Engine{
	public:
		...
		void displaySprite(const uint8_t *sprite, int16_t x, int16_t y, int16_t width, int16_t height);
		...
		void displaySpriteMatrix(const uint8_t **data, int8_t size, int16_t x, int16_t y, int16_t width, int16_t height);
};
